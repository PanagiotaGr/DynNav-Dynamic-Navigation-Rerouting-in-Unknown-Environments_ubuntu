...
class GridWorldEnv:
    ...
    def step(self, action):
        ...
        if next_state in self.obstacles:
            ...
            # Basic reward shaping: αρνητικό βήμα, θετικό όταν πλησιάζει goal
...
def train_q_learning(
    ...
    for ep in range(episodes):
        ...
        # ελαφρύ decay της εpsilon για λιγότερο exploration
...
def prm_build_roadmap(
    ...
    for i, p in enumerate(nodes):
        ...
        for j, dist in neighbors:
            # Εδώ θα έμπαινε line-collision check αν θέλαμε πιο αυστηρό PRM
